...
root_dir = ""
DATASET_REGISTRY = {
    "mvtec":       (mvtec.Dataset, mvtec.DatasetSplit, f"{root_dir}mvtec_anomaly_detection"),
    "visa":        (visa.Dataset, visa.DatasetSplit, f"{root_dir}/Industrial_Datasets/VisA_20220922"),
    "btad":        (btad.Dataset, btad.DatasetSplit, f"{root_dir}/Industrial_Datasets/BTAD/BTech_Dataset_transformed"),
    "mpdd":        (mpdd.Dataset, mpdd.DatasetSplit, f"{root_dir}/Industrial_Datasets/MPDD"),
